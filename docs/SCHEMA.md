...
> Matches migrations: `supabase/migrations/0001_initial_schema.sql` through `0008_content_action_type.sql`

## Overview

Seven core tables plus pgvector. Every table has RLS enabled from day one so policies can be added without a migration later.
